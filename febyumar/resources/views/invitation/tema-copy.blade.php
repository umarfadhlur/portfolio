...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .bg-red { background:#8A1C1A; color:white; }
        ...
        .split-two img { width:48%; max-width:500px; height:auto; border-radius:8px; }
        ...
        .btn {
            ...
            border-radius:30px; background:#8A1C1A;
            color:white; text-decoration:none; font-weight:600; display:inline-block;
        }

        #musicToggle {
            position:fixed; bottom:25px; right:25px;
            width:55px; height:55px; background:#8A1C1A; border-radius:50%;
            display:flex; align-items:center; justify-content:center;
            cursor:pointer; box-shadow:0 5px 18px rgba(0,0,0,0.3); z-index:999;
        }
        #musicToggle svg { fill:white; width:28px; height:28px; }
    </style>
</head>
...
<body>
    ...
    <section class="center section-block" data-aos="fade-up" data-aos-delay="400" data-aos-anchor-placement="top-center">
    ...
    <section id="rsvp" class="center section-block" data-aos="fade-up" data-aos-delay="450" data-aos-anchor-placement="top-center">
        <h2 class="title-hand" style="font-size:2rem;">Konfirmasi Kehadiran</h2>
        <form method="POST" action="{{ route('rsvp.store') }}" style="margin-top:30px; max-width:450px; margin-inline:auto;">
            @csrf
            <input type="text" name="name" value="{{ $guestName }}" required style="padding:12px; width:100%; margin-bottom:12px;">
            <input type="tel" name="phone" placeholder="Nomor WhatsApp" required style="padding:12px; width:100%; margin-bottom:12px;">
    ...
    @if ($setting->music_file)
        <button id="musicToggle"><svg viewBox="0 0 24 24"><path d="M12 3v10.55..."/></svg></button>
